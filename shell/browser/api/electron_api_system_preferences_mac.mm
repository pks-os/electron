...
v8::Local<v8::Value> GetUserDefault(NSUserDefaults* defaults,
...
void SystemPreferences::SetUserDefault(NSUserDefaults* defaults,
                                       const std::string& name,
                                       const std::string& type,
...
v8::Local<v8::Value> SystemPreferences::GetUserDefault(
  ...
  return GetUserDefault(defaults, key, type);
}
...
v8::Local<v8::Value> SystemPreferences::GetUserDefaultForSuite(
  ...
  base::scoped_nsobject<NSUserDefaults> defaults([[NSUserDefaults alloc]
      initWithSuiteName:base::SysNSStringToUTF8(suite)]);
  return GetUserDefault(defaults, key, type);
}
...
void SystemPreferences::SetUserDefault(const std::string& key,
                                       ...
                                       gin_helper::Arguments* args) {
  NSUserDefaults* defaults = [NSUserDefaults standardUserDefaults];
  SetUserDefault(defaults, key, type, args);
}
